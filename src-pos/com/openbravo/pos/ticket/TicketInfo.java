...
// TO DO  Add Waiter to TicketsBagShared
// JG 29 Aug 13 - Add User to SharedList (serialized_whilst testing)
// For use with multi-user + user switching mainly in restaurant mode + tables
//            name.append(m_User.toString());
//            name.append(" - ");
// ***********            
